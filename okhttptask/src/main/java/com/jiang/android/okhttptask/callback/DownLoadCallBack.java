...
package com.jiang.android.okhttptask.callback;


import com.jiang.android.okhttptask.ws_ret;
...
public abstract class DownLoadCallBack<N> extends HttpCallBack<N> {
    ...
    public abstract void onSuccess(N ret);  //成功
